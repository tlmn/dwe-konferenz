export default [
  {
    ...
    <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        ...
        <p>Mit <strong>Andrej Holm</strong> (Stadtforscher an der HU Berlin)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        ...
        <p>Mit <strong>Franziska Drohsel</strong> (Rechtsanw&auml;ltin, Berlin)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        title:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        <p>Die dabei relevant werdenden Themen spielen in der Mieter*innenbewegung Berlins schon lange eine Rolle: Zu Fragen der Mieter*innenmitbestimmung und zur transparenten und diskriminierungsarmen Wohnungsvergabe z.B. gibt es bereits differenzierte Diskussionen und praktische Erfahrungen. Auf diesem Panel wollen wir unsere bisherigen Ideen vorstellen und am Beispiel dieser Aspekte mit Akteur*innen der Mietenbewegung ins Gespr&auml;ch dar&uuml;ber kommen, wie die neu zu gr&uuml;ndende Anstalt &ouml;ffentlichen Rechts konkret aussehen kann.</p>
        <p>Mit <strong>Ulrike Hamann</strong> (Kotti & Co., ehemalige Vorst&auml;ndin der Wohnraumversorgung Berlin - Anstalt &ouml;ffentlichen Rechts), <strong>Marie Schubenz</strong> (Mieterrat Neues Kreuzberger Zentrum), <strong>Remzi Uyguner</strong> (T&uuml;rkischer Bund Berlin), <strong>Marieke und Ika</strong> (AG Vergesellschaftung, Deutsche Wohnen und Co enteignen)</p>`,
      },
      {
        title:
        ...
        <p>Referent:innen: Hannes Strobel und Nina Scholz (AG Starthilfe von DWE)</p>`,
      },
      {
        title:
      ...
      },
      {
        ...
        <p>Wir stellen unsere Arbeitsweise vor, analysieren gemeinsam Posts, sprechen &uuml;ber praktische Tipps und politische Kommunikation in Sozialen Medien. Au&szlig;erdem wird es praktische &Uuml;bungen geben, bitte bringt daher wenn m&ouml;glich einen Laptop mit.&nbsp;</p>
        <p>Referent*innen: Mareike &amp; Marcel (Social Media AG DWE) </p>`,
      },
      {
        title:
        ...
        <p>Mit <strong>Knut Unger</strong> (MieterInnenverein Witten/Kritische Immobilienaktion&auml;rInnen); Daniel Zimmermann (Koordinator Gro&szlig;e Wohnungsunternehmen beim Deutschen Mieterbund, angefragt), <strong>Ursel Beck</strong>, Mieterini Stuttgart; Moderation: <strong>Philipp M&ouml;ller</strong> (Redaktion MieterEcho, wissenschaftlicher Mitarbeiter Niklas Schenker, MdA DIE LINKE)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        title:
        ...
        <p>Mit <strong>Caren Lay</strong> (MdB DIE LINKE); <strong>Benjamin Raabe</strong> (RAV AK Mietrecht); <strong>Monika Schmid-Balzert</strong> (Kampagne Mietenstopp/Landesgesch&auml;ftsf&uuml;hrerin DMB Bayern); <strong>Sanna Raab</strong> (B&uuml;ndnis gegen Verdr&auml;ngung und Mietenwahnsinn, Berlin), Moderation: <strong>Armin Kuhn</strong> (Rosa-Luxemburg-Stiftung)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        ...
        <p>2017 wurde in Frankfurt am Main der Mietentscheid Frankfurt gegr&uuml;ndet, der 2018 &uuml;ber 25.000 Unterschriften sammelte. Ziel war es, die Anzahl der Sozialwohnungen in der Skyline Metropole enorm nach oben zu schrauben. Hier sollte es ebenfalls parallel zur Europawahl 2019 zur Abstimmung kommen - Es kam nie dazu. Der Mietentscheid Frankfurt wurde von der Stadt nie zugelassen, und 2022 endg&uuml;ltig vom Verwaltungsgericht abgeschmettert.</p>
        <p>Im Workshop m&ouml;chten wir aus unseren parallelen Erfahrungen berichten. Wie gestaltete sich die Zusammenarbeit zwischen Aktivist*innen, Wohlfahrtsverb&auml;nden, Parteien und Mieter*inneninitiativen? Konnten die anf&auml;nglichen Ziele erreicht werden, und wenn nein: warum nicht? An welchen Punkten wurden Aktivist*innen desillusioniert und was sind Stolpersteine, was hingegen auch unerwartete Erfolge?&nbsp;</p>
        <p>Ein Workshop zu den Erfahrungen aus Osnabr&uuml;ck und Frankfurt am Main</p>
      ...
      },
      {
        ...
        <p>W&auml;hrend die Immobilienwirtschaft und SPD behaupten die Entsch&auml;digung w&uuml;rde 36 Milliarden Euro kosten, kommt Deutsche Wohnen und Co enteignen auf 8 Milliarden. Wie kommen diese Zahlen eigentlich zustande?&nbsp;</p>
        <p>Berlin muss f&uuml;r die Umsetzung ein Vergesellschaftungsgesetz schreiben da es auf Bundesebene keins gibt. Was passiert wenn der Bund selber eins erstellt?&nbsp;</p>
        <p>In dem Workshop wollen wir uns mit der Frage nach Entsch&auml;digung eingehender besch&auml;ftigen. Was ist eigentlich juristisch gekl&auml;rt? Was ist noch zu kl&auml;ren und inwieweit hat das mit politischen Vorstellungen zu tun?</p>
        <p>Referent*innen: Dr. <strong>Franziska Drohsel </strong>(Rechtsanw&auml;ltin), Prof. <strong>Tim Wihl</strong>&nbsp;</p>
        <p>Moderation: <strong>Joanna Kusiak</strong> (DWE)</p>`,
      },
      {
        ...
        <p>Zentrale Fragen, die in Plenumsdebatten nach Bauchgef&uuml;hl oder individuellen Erlebnissen diskutiert werden, k&ouml;nnen datenbasiert empirisch bestimmt werden, oder?&nbsp;</p>
        <p>Die Datentaskforce berichtet &uuml;ber Mapping, Statistik und Fallstricke der Kommunikation.</p>`,
      },
      {
      ...
      },
      {
        ...
        <p>Es diskutieren <strong>Santi Mas de Xax&agrave;s Faus</strong>, <strong>Noelia Ria&ntilde;o</strong> und <strong>Sonia Galindo</strong> (PAH Barcelona), <strong>Joao Franca</strong> (Autor des PAH-Handbuchs), <strong>Hannes Strobel </strong>und<strong> Adelaide Iv&aacute;nova</strong> (Deutsche Wohnen &amp; Co. enteignen, AG Starthilfe bzw. R2C) sowie Aktivist*innen von <strong>H&auml;nde weg vom Wedding </strong>und vom <strong>B&uuml;ndnis Zwangsr&auml;umungen verhindern</strong>. Moderation: <strong>Vera Bartolom&eacute;</strong> (Rosa-Luxemburg-Stiftung, Madrid). Der Workshop wird Spanisch-Deutsch-Englisch gedolmetscht.</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>
        <p>How do we welcome new people to assemblies? How do we organize a decentralized movement? How do we carry out nonviolent direct action, how do we negotiate? How can we change narratives and perceptions and harness the power of the street? These are the kinds of questions that all housing initiatives must answer. On this panel, the <em>Platform for People Affected by Mortgages (PAH)</em> in Spain and the initiatives from Berlin, <em>B&uuml;ndnis Zwangsr&auml;umung Verhindern</em>, <em>H&auml;nde Weg vom Wedding</em> and <em>Deutsche Wohnen &amp; Co. enteignen</em> share their answers and experiences.</p>
        <p><br />Discussion with <strong>Santi Mas de Xax&agrave;s Faus</strong>, <strong>Noelia Ria&ntilde;o</strong> and <strong>Sonia Galindo</strong> (PAH Barcelona), <strong>Joao Franca</strong> (author of the PAH handbook), <strong>Hannes Strobel</strong> und <strong>Adelaide Iv&aacute;nova</strong> (Deutsche Wohnen &amp; Co. enteignen AG Starthilfe/R2C), activists from <strong>B&uuml;ndnis Zwangsr&auml;umung</strong> <strong>Verhindern</strong> and <strong>H&auml;nde weg vom Wedding</strong>. Moderation: <strong>Vera Bartolom&eacute;</strong> (Rosa Luxemburg Foundation, Madrid). The event will be interpreted Spanish-German-English.</p>`,
      },
      {
        title:
        ...
        <p>Lisa Wagner, Josephine Br&auml;mer, Kalle Kunkel, Nina Scholz (AG Starthilfe von DWE), plus Kiezteam Tempelhof-Sch&ouml;neberg</p>
        <p>Treffen vor der TU, gemeinsame An- und Abreise</p>`,
      },
      {
        title:
        ...
        <p>Mit <strong>Christoph Trautvetter</strong> (ext. Projektleiter &bdquo;Wem geh&ouml;rt die Stadt&ldquo;, RLS), <strong>Dirk L&ouml;hr</strong> (Hochschule Trier), <strong>Lorena Jonas</strong> (Bizim Kiez) moderiert von <strong>Stefan Thimmel</strong> (Rosa-Luxemburg-Stiftung)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        title:
      ...
      },
      {
        ...
        <p>Moderation: Heiner Koch (Die Genossenschafter*innen)</p>
        <p>Mit: Marie Schubenz (Kommunal &amp; Selbstverwaltet Wohnen)</p>`,
      },
      {
        ...
        <p>Mit: Vertreterinnen der Kampagne Mietenstopp: Monika Schmid-Balzert (DMB Landesverband Bayern), Werner Eggert (Recht auf Stadt K&ouml;ln), Rouzbeh Taheri (DWE)</p>`,
      },
      {
        title:
        ...
        <p>Mit <strong>Christoph Trautvetter</strong> (Netzwerk Steuergerechtigkeit; externer Projektleiter &bdquo;Wem geh&ouml;rt die Stadt?&ldquo; bei der Rosa-Luxemburg-Stiftung); <strong>Gabriela Keller</strong> (Investigativreporterin bei Correctiv) u.a. Moderation: <strong>Katalin Gennburg</strong> (MdA DIE LINKE Berlin)</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>
        <p>Livestream</p>`,
      },
      {
      ...
      },
      {
        ...
        <p>Der Workshop wird in 4 Phasen geteilt:</p>
        <ol>
        <li> Es war einmal: wie, warum und von wem wurde R2C geschaffen?</li>
        <li> #TBT: ein &Uuml;berblick unserer externen Aktivit&auml;ten seit Dezember 2020</li>
        <li> Lessons Learned: Nachdem wir einen Bericht &uuml;ber interne Strukturen und Praxis gegeben haben, teilen wir mit, was erfolgreich war und weiter verwendet werden sollte :) was verbessert werden musst :| und was wir nicht hinbekommen haben :(&nbsp;</li>
        <li> Was bedeutet &bdquo;Blase&ldquo; &uuml;berhaupt? Experimenten aus den Recht auf Stadt Bewegungen in Spanien und Brasilien, und was davon k&ouml;nnen wir als Referenz f&uuml;r unser eigene Praxen in Berlin und DWE verwenden.</li>
        </ol>`,
      },
      {
      ...
      },
      {
        ...
        <p>Wie genau, das diskutieren Aktive der Gewerkschaftsinitiative in Berlin und internationale Mietengewerkschafter*innen. Sie sprechen &uuml;ber Organisierungsans&auml;tze, die Verteilung der Arbeit, Skalierung und Vernetzung der Strukturen, und die Beziehung zu Politiker*innen auf kommunaler Ebene.</p>
        <p><em>// Union organizing is not only found in the sphere of production, but also in other spheres as collective resistance against exploitation and commodification by capital. For example in the UK, Spain or Sweden, where tenants' unions stand up</em> <em>against landlordism and for the rights of all tenants. Since 2019, such initiatives also exist in Germany in the mosaic of rent initiatives, alliances and tenants' associations. They want to strengthen the rights and struggles of all tenants, building the collective power of tenants, and work beyond the traditional realm of legal advice and support.</em></p>
        <p><em>How exactly, will be discussed by activists of the tenants union initiative in Berlin and international tenants' unionists. They talk about approaches to organizing, the distribution of work, scaling and networking of structures, and the relationship with politicians at the local level.</em></p>
        <p>Mit <strong>Mieter*innengewerkschaft Berlin</strong>, <strong>London Renters Union, Living Rent, Sindicat de Llogateres</strong> (alle angefragt)</p>
        <p>Moderiert von <strong>Anastasia Blinzov</strong> (Rosa-Luxemburg-Stiftung) und <strong>Joe Beswick</strong> (Rosa-Luxemburg-Stiftung, London office)</p>
        <p><em>// </em><strong><em>Mieter*innengewerkschaft Berlin</em></strong><em>, </em><strong><em>London Renters Union</em></strong><em>, </em><strong><em>Living Rent, Sindicat de Llogateres </em></strong><em>(all requested)</em></p>
        <p><em>Facilitated by </em><strong><em>Anastasia Blinzov</em></strong><em> (Rosa-Luxemburg-Stiftung) and </em><strong><em>Joe Beswick </em></strong><em>(Rosa-Luxemburg-Stiftung, London office)</em></p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        title:
        ...
        <p>Im Workshop wollen wir Prinzipien gemeinn&uuml;tzigen und gemeinwohlorientierten Wohnens diskutieren und Ans&auml;tze besprechen, die dauerhaft ein Wohnen jenseits des Markts erm&ouml;glichen. Dabei wollen wir auch Erfahrungen des genossenschaftlichen Wohnens ber&uuml;cksichtigen. Ziel des Workshops ist eine Diskussion der Herausforderungen und Konflikte bei der Verwirklichung sozialer, &ouml;kologischer und demokratischer Ziele der Wohnraumversorgung.</p>
        <p>Mit: <strong>Gisela Notz</strong>, Sozialwissenschaftlerin und Historikerin, Autorin; <em>Schwerpunkt</em>: Beitrag von Genossenschaften zu einer progressiven Wohnungspolitik</p>
        <p><strong>Hilde Schrader</strong>, Genossenschafterin aus Berlin, aktiv bei der Initiative Die Genossenschafter*innen; <em>Schwerpunkt</em>: Erfahrungen mit Gemeinwohlbilanzen; Gemeinwohlbilanzen als Instrument f&uuml;r eine Transformation von Wohnungsunternehmen</p>
        <p><strong>Inga Jensen, </strong>Politikwissenschaftlerin und Urbanistin, Promotion an der Uni Erfurt, <em>Schwerpunkt</em>: (Re-)Kommunalisierung von Wohnraum</p>
        <p>Moderation: Sebastian (Genossenschafter*innen)</p>`,
      },
      {
        title:
      ...
      },
      {
        ...
        <p>Mit <strong>Lena Kreck</strong> (Senatorin f&uuml;r Justiz, Antidiskriminierung, Vielfalt, DIE LINKE), <strong>Lisa Vollmer</strong> (Bauhaus-Uni Weimar), <strong>Lukas Siebenkotten</strong> (Deutscher Mieterbund), <strong>Isabella Rogner</strong> und <strong>Kalle Kunkel</strong> (Deutsche Wohnen &amp; Co. enteignen), moderiert von <strong>Armin Kuhn</strong> (Rosa-Luxemburg-Stiftung)</p>
        <p>Livestream</p>`,
      },
    ],
  },
    ...
    items: [
      {
        ...
        <p>Mit dem Faire-Mieten-Modell zeigt die Kampagne, wie die Vergesellschaftung haushaltsneutral gelingt und trotzdem sozial vertr&auml;gliche Mietpreise etabliert werden k&ouml;nnen. Aber lassen sich so auch die Klimaanpassung im Bestand, und der Neubau von nachhaltigem und preisg&uuml;nstigen Wohnraum finanzieren? Und welche Chancen bietet die Vergesellschaftung von Wohnraum f&uuml;r die sozial, wie klimagerechte Stadt?</p>
      ...
      },
      {
        ...
        <ul>
        <li>Die Rolle von Sprecher*innen in Initiativen</li>
        <li>Was ist eine Nachricht? Und was nicht?</li>
        <li>Kernbotschaften und O-T&ouml;ne&nbsp;</li>
        <li>Wie schreibe ich eine Pressemitteilung?</li>
        <li>Beziehungen zu Journalist*innen aufbauen und pflegen</li>
        <li>Interviews vorbereiten, geben und autorisieren</li>
        </ul>
        <p>Teil des Workshops sind kurze, praktische &Uuml;bungen.&nbsp;</p>
        <p>Mit Christoph von Hamburg Enteignet</p>`,
      },
      {
        title:
        ...
        <ol>
        <li> Once up a time: how, why and by whom was Right2TheCity created?</li>
        <li> #TBT: an overview of our external activities since December 2020</li>
        <li> Lessons learned: After a report of our internal structures and practise, we will explain what was successful and should be tried again :) what must be improved :[ and what we never managed to do :(</li>
        <li> &ldquo;Not German enough&rdquo; How can non-Germans work at eye level with our German partners, and gain recognition for our specific contribution?</li>
        </ol>`,
      },
      {
        title:
        ...
        <p>Innerhalb der Bewegung laufen die Diskussionen: Welche Organisationsformen werden f&uuml;r die Zeit nach der Volksentscheid-Kampagne gebraucht? Welche Ziele soll sich die Initiative mittelfristig setzen? Wie k&ouml;nnen die Strukturen aktiv bleiben? Wie soll sich die Initiative mit anderen Gruppen und K&auml;mpfen verbinden?</p>
        <p>Im Workshop sollen diese Fragen mit Aktiven aus Recht-auf-Wohnen-Gruppen aus Amsterdam, Barcelona, Belgrad, Zagreb und Berlin diskutiert werden. SIe werden die Lehren teilen, die sie aus ihren K&auml;mpfen gezogen haben, und mit uns debattieren, wie wohnungspolitische Bewegungen mit einem munizipalistischen Ansatz und dem Recht auf Stadt verbunden werden k&ouml;nnen.</p>
        <p>After winning the referendum, DWE expects the Senate of Berlin to act according to the decision made by its citizens. At the same time, the documented ties between political parties like the SPD with the real estate and corporate landlord lobbies, oblige DWE to keep pushing for democratizing access to housing until expropriation is implemented. The question is how to do it in this new phase.</p>
        <p>The movement is now debating how to organize beyond the time of the campaign, how to define new goals in the middle term, how to keep active its community, or how to relate to other groups and initiatives.</p>
        <p>We will discuss these questions with activists of right-to-housing groups from Amsterdam, Barcelona, Belgrade, Zagreb, and Berlin. They will share lessons learned from their movements and discuss how to connect housing movements with municipalism and the right to the city.</p>
        <p>Speakers: <strong>Iva Iv&scaron;ić</strong> (Zagreb je NA&Scaron;!), <strong>Jovana Timotijević</strong> (Ministry of Space, Belgrad), <strong>Melissa Koutouzis</strong> (Woonprotest Amsterdam) and <strong>Santi Mas de Xax&agrave;s Faus</strong> (PAH Barcelona). Moderated by <strong>Xavi Ferrer</strong>.</p>
        <p><em>Eine Veranstaltung der Rosa-Luxemburg-Stiftung</em></p>`,
      },
      {
        title:
      ...
      },
      {
        ...
        <p>Mit Aktivist*innen aus Berlin und dem Bundesgebiet</p>`,
      },
    ],
  },
];
