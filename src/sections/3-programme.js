...
Referent: Christoph Trautvetter (ext. Projektleiter „Wem gehört die Stadt“, RLS), moderiert von Stefan Thimmel (RLS)
 ...
 <ProgrammeItem
     ...
     <br/>
     Inputs ok -sabine notz tbc - Christian Felber, Gemeinwohlökonomie - Sabine Horlitz (Mitautorin ‚Neue Wohnungsgemeinnützigkeit, RLS 2017‘ / Stadtbodenstiftung - Person von DWE (zu Gemeinwirtschaft) - Person von Immovilien / Montagsstiftung / NABU Bodenbesteuerung (Ulrich Kriese) Moderation: Sebastian Botzem (Genossenschafter*innen)
  ...
  <SessionTitle className="text-yellow">
      ...
      <ProgrammeItem
        ...
        time="19-21 Uhr"
      >
       mit Lena Kreck (Senatorin Justiz, Antidiskriminierung, Vielfalt), Lisa Vollmer (Bauhaus-Uni Weimar), Lukas Siebenkotten (DMB), N.N. (Ko-Kreis DWE), <br/>
