    ...
    <ReadMore className="text-yellow bg-purple">
      ...
      <div className="dwe-grid">
        <Body>
          ...
          nicht nur zum Diskutieren, sondern auch ganz konkrete Zukunftspläne zu
          schmieden:
        </Body>
        ...
        <Body>
          Durch das gemeinsame Diskutieren und Beantworten dieser Fragen soll es
          uns dann möglich werden, ganz konkret zu werden: Wie baut man
          ...
          sind alle, die Interesse haben: Ob Du langjährige Wohnraumaktivist*in
          bist oder einfach Interesse hast, ob Du in Bayern oder in Berlin
          wohnst - alle sind willkommen und eingeladen. Es wird eine
          Schlafplatzbörse geben. Hierzu informieren wir zeitnah. Das
          vollständige Programm ist gerade noch in Arbeit, bald wird es weitere
          Infos zu Programm und Ablauf folgen.
        </Body>
      </div>
    </ReadMore>
  </Section>
